// ============================================================================
// mine2 — Hypothesized (symmetric GPD) + fixed log(trial) effect
//
// vs Hyp:  +3 population params only, 0 individual params added
// vs mine1: goal equation uses single beta_gp_g * (perf - goal)
//           instead of separate success/failure coefficients
// 11 individual-level parameters (same as hyp)
// Goal:  beta_gp_g * (perf - goal)  + beta_lt_g * log(t)
...
parameters {
  // Population means (same 11 as hyp)
  ...
  // NCP offsets (N x 11, same as hyp)
  matrix[N, 11] z;
